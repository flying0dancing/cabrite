...
public interface IConfigCmd {
    String ICC_SOURCEFOLDER=System.getProperties().containsKey("source")?System.getProperty("source"):null;

    String ICC_RESULTFOLDER=System.getProperties().containsKey("result")?System.getProperty("result"):null;
