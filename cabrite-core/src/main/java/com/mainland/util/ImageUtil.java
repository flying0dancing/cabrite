...
public class ImageUtil {
     ...
     * @param resultFolder the folder which result in
     * @return
     */
    public static String[] compareWithExpectation(String actual, String expected, String resultFolder){
        resultFolder=Strs.reviseFilePath(resultFolder+System.getProperty("file.separator"));
        FileUtil.createDirectory(resultFolder);
        double tolerance=0;
        ...
        obj[0]=Double.toString(100-tolerance*100);
        obj[1]=resultFolder+lower_output;//actual
        obj[2]=resultFolder+middle_output;//expected
        return obj;
    }
