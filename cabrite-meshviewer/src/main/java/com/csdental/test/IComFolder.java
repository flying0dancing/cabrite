...
public interface IComFolder extends IConfigCmd{
    ...
    String SCREENSHOT_FOLDERNAME=Strs.removeLastSlash(PropHelper.getProperty("path.screenshot.folder"));
    ...
    String RESULT_EXPECTATION_FOLDER = RESULT_FOLDER+"/expectation/";
}
